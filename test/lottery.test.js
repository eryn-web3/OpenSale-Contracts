...
contract('Lottery', (accounts) => {
    it('init', async () => {
        ...
        this.odc = await MockBEP20.deployed();
        ...
        await this.odc.transfer(bob, '2000', { from: minter });
        await this.odc.transfer(alice, '2000', { from: minter });
        await this.odc.transfer(carol, '2000', { from: minter });
    });
    ...
    it('test', async () => {
        ...
        carol=accounts[3];
        dev=accounts[4];
        await this.odc.approve(this.lotteryProxyAddress, '1000', { from: alice });
        await this.odc.approve(this.lotteryProxyAddress, '1000', { from: bob });
        ...
        assert.equal((await this.odc.balanceOf(this.lotteryProxyAddress)).toString(), '418');
